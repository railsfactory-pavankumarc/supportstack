ActiveAdmin.register User, :as => "client" do
  ...
  permit_params :first_name, :last_name, :department_id, :role_id, :company_name, :mobile_no, :fax, :email, :password, :password_confirmation, :client, attachment_attributes: [:attachment]
